...
if (!tienePermiso('colaboradoras', 'eliminar')) {
    echo json_encode(['success' => false, 'message' => 'No tiene permisos para eliminar colaboradoras.']);
    exit;
}
...
if ($id) {
    ...
    $sql = "DELETE FROM colaboradoras WHERE idcolaboradora = ?;";
    ...
    if ($stmt->execute()) {
        ...
        echo json_encode(['success' => false, 'message' => 'Esta colaboradora cuenta con citas asociadas.']);
    }
