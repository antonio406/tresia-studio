...
if (!tienePermiso('clientas', 'eliminar')) {
    echo json_encode(['success' => false, 'message' => 'No tiene permisos para eliminar clientas.']);
    exit;
}
...
if ($id) {
    ...
    $sql = "DELETE FROM clientas WHERE idclienta = ?;";
    ...
    if ($stmt->execute()) {
        ...
        echo json_encode(['success' => false, 'message' => 'Esta clienta cuenta con citas asociadas.']);
    }
