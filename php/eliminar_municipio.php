...
if (!tienePermiso('municipios', 'eliminar')) {
    echo json_encode(['success' => false, 'message' => 'No tiene permisos para eliminar municipios.']);
    exit;
}
...
if ($id) {
    ...
    if ($stmt->execute()) {
        ...
        echo json_encode(['success' => false, 'message' => 'El Municipio ya se agrego a una clienta.']);
    }
