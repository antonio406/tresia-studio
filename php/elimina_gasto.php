...
if (!tienePermiso('gastos', 'eliminar')) {
    echo json_encode(['success' => false, 'message' => 'No tiene permisos para eliminar gastos.']);
    exit;
}
...
if ($id) {
    ...
    if ($stmt->execute()) {
        echo json_encode(['success' => true, 'message' => 'Gasto eliminado con éxito.']);
    } else {
