...
if (!tienePermiso('inventario', 'crear')) {
...
<head>
    ...
    <script src="js/agrega_producto.js" defer></script>
</head>
<body>
    <?php include('php/sidebar.php'); ?>
    <div class="content">
        <div class="form-container">
            <h2 id="formTitle">Agrega Producto</h2>
            <form id="clientaForm">
                <table>
                    <tr>
                        <th>Descripcion</th>
                        <td><input type="text" name="fecha" id="descripcion" required></td>
                    </tr>
                    <tr>
                        <th>Unidades</th>
                        <td><input type="text" name="unidad" id="unidad" required></td>
                    </tr>
                    <tr>
                        <th>Precio</th>
